...
// Stop bot function (Updated: Clear user-specific data, prevent retry on manual stop)
function stopBot(userId) {
  ...
  learnedResponses.triggers = [];  // Clear learned responses
...
// Start bot function (Updated: Prevent retry on manual stop, no unlimited loops)
            ...
            try {
              ...
              if (isGroup && event.senderID && event.senderID !== botID) {
                ...
                if (botState.memberCache[threadID].size > 50) {
                  botState.memberCache[threadID].clear(); // Clear if too many
                }
              }
