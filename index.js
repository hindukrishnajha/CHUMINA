        ...
        const listenMqtt = (mqttAttempt = 1, maxMqttAttempts = 3) => {
          ...
          api.listenMqtt(async (err, event) => {
            ...
            try {
              ...
              // Handle message_unsend event without senderID check
              ...
              // Skip other events if senderID is null and not allowed
              if (!senderID && !['log:thread-name', 'log:thread-admins', 'typ', 'presence'].includes(event.type)) { // 'presence' add kiya
