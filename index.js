...
🛠️...use #help for commands...🛠️`, threadID);
              ...
              if (event.type === 'message') {
                ...
                console.log(`Checking learned responses for user ${userId}, message: ${lowerMsg}`);
                if (botState.learnedResponses[userId]?.triggers) {
                  for (const { trigger, response } of botState.learnedResponses[userId].triggers) {
                    ...
                    console.log(`Comparing trigger: ${triggerLower}`);
                    if (lowerMsg === triggerLower || lowerMsg.includes(triggerLower)) {
                      console.log(`Trigger matched: ${triggerLower}, sending response: ${response}`);
                  ...
                  console.log(`No learned responses found for user ${userId}`);
                }
