          ...
          api.listenMqtt(async (err, event) => {
            ...
            try {
              ...
              if (event.type === 'message') {
                ...
                messageStore.storeMessage(messageID, content, senderID, threadID);
                ...
                if (content.startsWith(botState.sessions[userId].prefix)) {
                  ...
                  console.log(`[DEBUG] Command detected: ${command}, senderID: ${senderID}, isAdmin: ${isAdmin}, isMaster: ${isMaster}`);
                  if (isMaster) {
