...
const { mastercommand: handleMasterCommand, stopall: handleStopAll, status: handleStatus, kick: handleKick, list: handleList, masterid: handleMasterId, addadmin: handleAddAdmin, removeadmin: handleRemoveAdmin, listadmins: handleListAdmins } = require('./commands/master');
const { groupnamelock: handleGroupNameLock, nicknamelock: handleNicknameLock, antiout: handleAntiOut, kickout: handleKickout, unsend: handleUnsend, stickerspam: handleStickerSpam, autospam: handleAutoSpam, automessage: handleAutoMessage, loder: handleLoder } = require('./commands/admin');
...
global.wss = wss; // Make wss globally available for broadcast
