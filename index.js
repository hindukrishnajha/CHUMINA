...
function startBot(userId, cookieContent, prefix, adminId) {
    ...
    try {
        ...
        console.log(`Cookies loaded for user ${userId}:`, loadedCookies);
    } catch (err) {
    ...
    wiegine.login(loadedCookies, {}, (err, api) => {
        if (err || !api) {
        ...
        console.log(`API object for user ${userId}:`, Object.keys(api)); // Debug API structure
