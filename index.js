...
function startBot(uniqueId, cookieContent, prefix, adminId) {
    ...
    try {
        ...
        console.error(`Invalid cookie content for uniqueId ${uniqueId}:`, err.message);
        broadcast({ type: 'error', message: `Invalid cookie content for uniqueId ${uniqueId}: ${err.message}`, uniqueId });
        return;
    }
