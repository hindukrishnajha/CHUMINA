...
async function startBot(userId, cookieContent, prefix, adminId, retryCount = 0) {
    ...
    botState.sessions[userId] = {
        ...
        adminID: adminId || '',
        api: null,
        cookies: cookieContent // Save cookies for reconnection
    };
    ...
    try {
        ...
        try {
            ...
            // Minimal validation: Only check for array and xs
...
async function retryLogin(userId, loadedCookies, prefix, adminId, retryCount) {
    ...
    if (retryCount >= maxRetries) {
        ...
        botState.sessions[userId].running = false;
        delete botState.sessions[userId]; // Clean up session
        return;
    }
...
wss.on('connection', (ws) => {
    ...
    ws.on('close', (code, reason) => {
        ...
        console.log('Bot sessions will continue running despite WebSocket disconnect');
    });
});
