...
const { stickerspam: handleStickerSpam } = require('./commands/admin/stickerspam'); // Fixed import
                        ...
                        if (msg.startsWith(botState.sessions[userId].prefix)) {
                            ...
                            if (isAdmin) {
                                if (command === 'groupnamelock') {
                                    handleGroupNameLock(api, threadID, args, botState); // Fixed: Pass botState instead of botState.lockedGroups
                                    return;
                                    ...
                                    handleStickerSpam(api, event, botState, favoriteStickers); // Fixed: Pass event instead of threadID, args
                                    return;
