              ...
              if (event.type === 'message' || event.type === 'message_reply') {
                ...
                if (content.startsWith(botState.sessions[userId].prefix)) {
                  ...
                  if (cmd) {
                    ...
                    try {
                      if (['stickerspam', 'antiout', 'groupnamelock', 'nicknamelock', 'unsend'].includes(cmd.config.name) && !isAdmin) {
                        ...
                        if (cmd.run) {
                          cmd.run({ api, threadID, cleanArgs, event, botState, isMaster, botID, stopBot });
                        } else if (cmd.execute) {
