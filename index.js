...
const { tid: handleTid } = require('./commands/user/tid');
const { uid: handleUid } = require('./commands/user/uid');
const { groupinfo: handleGroupInfo } = require('./commands/user/groupinfo');
const { info: handleInfo } = require('./commands/user/info');
const { pair: handlePair } = require('./commands/user/pair');
const { music: handleMusic } = require('./commands/user/music');
const { learn: handleLearn } = require('./commands/user/learn');
