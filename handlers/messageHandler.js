...
async function generateResponse(isTargetAdmin, targetMessage, targetName) {
    try {
        ...
        if (isTargetAdmin) {
            ...
            6. FAMILY & RELATIVES COMPLETELY BANNED: maa, behen, baap, bhai, dadi, nani, chacha, mausi, bua, chachi, patni, biwi, mummy, papa, aunty, uncle, bhabhi - YE SAB WORDS BILKUL BANNED HAI
            ...
            10. Full supportive tone, example: 
                ...
                - User: "pankaj ki gaand me kya h yaar aisha" → Jawab: "Ha malik, pankaj ki gaand me toh pakka kuch aisa hi hai jo aap keh rahe ho, aap sahi pakad rahe ho!"
